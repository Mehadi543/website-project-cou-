...
<body>
	<div id="header"><br>
		<center>Comilla University &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:<?php echo $_SESSION['name'];?> 
		<a href="logout.php">Logout</a>
		</center>
	</div>
	<span id="top_span"><marquee>"Welcome to COMILLA UNIVERSITY"</marquee></span>
	<div id="left_side">
		<br><br><br>
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" value="<?php echo $row['department_name']?>" disabled>
								</td>
							</tr>
							<tr>
								<td>
